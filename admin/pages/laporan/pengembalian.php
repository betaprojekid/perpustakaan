  ...
  <div class="col">
    <div class="card shadow">
      <div class="card-header bg-primary">
        <h2 class="card-title">Data Laporan Pengembalian Buku</h2>
      </div>
      <div class="card-body p-2">
        <div class="border-bottom mb-2 py-2">
          <div class="row">
            ...
            <div class="col">
              <a href="<?= base_url('admin/export/laporan-pengembalian.php?waktu=' . $waktu) ?>" class="btn btn-outline-info">
            ...
            <tbody>
              ...
              ?>
                <tr>
                  ...
                  <td><?= $list['judul'] ?></td>
                  <td><?= date("d F Y", strtotime($list['tgl_pinjam'])) ?></td>
                  <td><?= date("d F Y", strtotime($list['tgl_kembali'])) ?></td>
                </tr>
              <?php
              endforeach;
              ?>
