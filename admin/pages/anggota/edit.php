          ...
          <div class="col-6">
            <form action="<?= $action ?>" method="POST" autocomplete="off">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="nim" id="nim" placeholder="Masukkan NIM anda" required value="<?= $data['nim'] ?>">
              </div>

              <div class="form-group">
                <label for="nama_lengkap">Nama Lengkap</label>
                <input type="text" class="form-control" name="nama_lengkap" id="nama_lengkap" placeholder="Masukkan Nama Lengkap anda" required value="<?= $data['nama_lengkap'] ?>">
              </div>

              <div class="form-group">
                <label for="tempat_lahir">Tempat Lahir</label>
                <input type="text" class="form-control" name="tempat_lahir" id="tempat_lahir" placeholder="Masukkan tempat lahir anda" required value="<?= $data['tempat_lahir'] ?>">
              </div>

              <div class="form-group">
                <label for="tanggal_lahir">Tanggal Lahir</label>
                <input type="date" class="form-control" name="tanggal_lahir" id="tanggal_lahir" placeholder="Masukkan Nama Lengkap anda" required value="<?= $data['tgl_lahir'] ?>">
              </div>
