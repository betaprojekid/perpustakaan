...
$activeSheet->setCellValue('E1', 'Tanggal Pengembalian');
...
if(mysqli_num_rows($sql) > 0){
  ...
  while($row = mysqli_fetch_assoc($sql)){
    ...
    $activeSheet->setCellValue('E'.$i , date("d-m-Y", strtotime($row['tgl_kembali'])));
    $i++;
  }
}
...
$filename = 'laporan-pengembalian-buku-' . $ket . '-' . date('dmYhis') . '.xlsx';
